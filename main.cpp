...
int main(){
    ...
    */
    ...
    // . . . test your functions here
     ...
     std::vector<Profemon> test = {ML, SOFTWARE, HARDWARE};
  ...
  */
  ...
  Profemon Matthew("Matthew", 1, HARDWARE);
  Profemon Thanks("Thanks", 1, SOFTWARE);

  std::cout << me.getCurrent().getName() << "\n";

  std::cout << me.contains("Maryash") << "\n";  // 1
  std::cout << me.contains("Matthew") << "\n";  // 0
  std::cout << me.addProfemon(maryash) << "\n"; // 0
  std::cout << me.addProfemon(Thanks) << "\n";  // 1
  std::cout << me.contains("Thanks") << "\n";   // 1

  std::cout << me.removeProfemon("Maryash") << "\n"; // 1
  std::cout << me.contains("Maryash") << "\n";       // 0
  std::cout << me.addProfemon(Matthew) << "\n";      // 1
  std::cout << me.contains("Matthew") << "\n";       // 1
  me.setTeamMember(0, "Matthew");
  me.chooseProfemon(0);
  std::cout << me.getCurrent().getName() << "\n";
